 ...
 * 
 * import java.time.LocalDate; import java.util.ArrayList;import java.util.Date;
 * import java.util.List;
 * 
 * import org.springframework.beans.factory.annotation.Autowired; import
 * org.springframework.context.annotation.Role; import
 ...
 * 
 * import com.secure.bankapp.exception.InsufficientBalanceException; import
 * com.secure.bankapp.model.Account; import
 * com.secure.bankapp.model.RegistrationForm; import
 * com.secure.bankapp.model.Transaction; import
 * com.secure.bankapp.model.UserDetail; import
 * com.secure.bankapp.repository.UserDetailRepository; import
 * com.secure.bankapp.service.AccountService; import
 * com.secure.bankapp.service.EmployeeService; import
 * com.secure.bankapp.service.TransactionService; import
 * com.secure.bankapp.service.UserService; import
 * com.secure.bankapp.util.Constants;
 * 
 ...
 * transactionService.getCriticalTransactions());
 * 
 * return ""; }
 * 
 * @RequestMapping(value = "/emp2/approve", method = RequestMethod.POST) public
 * String approveTransactionsEmp2(@ModelAttribute("transactions")
 * List<Transaction> transactions, Model model) {
 * 
 * transactionService.approveTransactions(transactions);
 * 
 * return ""; }
 * 
 * @RequestMapping(value = "/emp2/reject", method = RequestMethod.POST) public
 * String rejectTransactionsEmp2(@ModelAttribute("transactions")
 * List<Transaction> transactions, Model model) {
 * 
 ...
 * return ""; }
 * 
 * @RequestMapping(value = "/emp1/approve", method = RequestMethod.POST) public
 * String approveTransactionsEmp1(@ModelAttribute("transactions")
 * List<Transaction> transactions, Model model) {
 * 
 * transactionService.approveTransactions(transactions);
 * 
 * return ""; }
 * 
 * @RequestMapping(value = "/emp1/reject", method = RequestMethod.POST) public
 * String rejectTransactionsEmp1(@ModelAttribute("transactions")
 * List<Transaction> transactions, Model model) {
 * 
 * transactionService.rejectTransactions(transactions);
 * 
 * return ""; }
 * 
 * @RequestMapping(value = {"/emp1/get/{userId}","/emp2/get/{userId}" }, method
 ...
 * public String modifyUserAccount(@ModelAttribute("userProfile") UserDetail
 ...
 * user.setPhone(userProfile.getPhone()); UserDetailRepository.save(user);
 * 
 * return ""; }
 * 
